    ...
    <div className="min-h-screen bg-gradient-to-br from-[#2C5F5D] via-[#1F4E4C] to-[#1A3D3B] flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-serif font-bold text-[#E8E3DB] mb-2">Admin Panel</h1>
          <p className="text-[#D4A574]/80">Rumah Aletheia - PT Academos Pustaka Demokrasi</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label htmlFor="username" className="block text-sm font-semibold text-gray-700 mb-2">Username / Email</label>
              <input
                type="text"
                id="username"
                value={username}
          ...
          <div className="mt-6 text-center">
            <Link href="/" className="text-sm text-gray-600 hover:text-[#B05E3F] transition-colors">← Kembali ke Website</Link>
          </div>
        </div>

        {/* Dev Note */}
        <div className="mt-6 text-center text-xs text-[#D4A574]/60">
