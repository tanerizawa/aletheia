    ...
    <>
      ...
      <section className="relative bg-[#2C5F5D] overflow-hidden" aria-label="Hero - Selamat datang di Rumah Aletheia">
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8 py-24 lg:py-32">
          <div className="max-w-4xl">
            ...
            <h1 className="font-serif text-5xl md:text-7xl font-bold mb-8 text-[#E8E3DB] leading-[1.1]">
              Rumah Aletheia
            </h1>
            <p className="text-xl md:text-2xl mb-10 text-[#D4A574] leading-relaxed max-w-2xl">
              Tempat di mana keberanian bertemu kebijaksanaan melalui pengetahuan dan pembelajaran
            </p>
            <Link
              href="/kegiatan"
              className="inline-block bg-[#B05E3F] text-[#E8E3DB] px-10 py-4 font-semibold hover:bg-[#9A5035] transition-all border-2 border-[#B05E3F] hover:border-[#9A5035] shadow-lg hover:shadow-xl"
            >
              Jelajahi Kegiatan
            </Link>
          </div>
      ...
      <section className="py-20 bg-white border-t-4 border-b-4 border-[#2C5F5D]">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <Link
            href="/kontak"
            className="inline-block bg-[#2C5F5D] text-[#E8E3DB] px-10 py-4 font-semibold hover:bg-[#1F4E4C] transition-all border-2 border-[#2C5F5D] hover:border-[#1F4E4C]"
