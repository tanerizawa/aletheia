  ...
  return (
    <>
      {/* ==========================================
          ...
          ========================================== */}
      <section 
        className="relative min-h-[85vh] flex items-center justify-center overflow-hidden hero-outer"
        aria-label="Halaman Depan Rumah Aletheia"
      >
        {/* Decorative elements - gate pillars */}
        <div className="absolute left-0 top-0 bottom-0 w-8" aria-hidden="true" style={{ backgroundImage: 'linear-gradient(to right, var(--color-secondary), transparent)', opacity: 0.3 }}></div>
        <div className="absolute right-0 top-0 bottom-0 w-8" aria-hidden="true" style={{ backgroundImage: 'linear-gradient(to left, var(--color-secondary), transparent)', opacity: 0.3 }}></div>
        ...
        <div className="relative z-10 hero-inner py-16 text-center">
          {/* Welcome Text */}
          <div className="mb-4 animate-[fadeIn_0.8s_ease-in]">
            <span className="hero-label inline-block animate-[fadeIn_0.8s_ease-in] border-b-2 border-terra-light pb-2">
              Selamat Datang di
            </span>
          </div>
          ...
          <p className="text-lg mb-8 font-serif italic animate-[fadeIn_1.2s_ease-in]" style={{ color: 'var(--color-cream-soft-white)' }}>
            Perpustakaan PT Academos Pustaka Demokrasi
          </p>
          
          {/* Tagline */}
          <p className="text-xl lg:text-2xl hero-lead mb-12 max-w-3xl mx-auto leading-relaxed animate-[fadeIn_1.4s_ease-in]">
            Tempat di mana <span className="text-[var(--hero-accent-color)] font-semibold">keberanian</span> bertemu{' '}
            <span className="text-[var(--hero-accent-color)] font-semibold">kebijaksanaan</span> melalui pengetahuan dan pembelajaran
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-8 mb-12 animate-[fadeIn_1.6s_ease-in]">
            <div className="text-center">
              ...
              <div className="text-sm uppercase tracking-wider mt-1" style={{ color: 'var(--color-cream-soft-white)' }}>Koleksi Buku</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-terra-light font-serif">{library.stats.members.toLocaleString('id-ID')}+</div>
              <div className="text-sm uppercase tracking-wider mt-1" style={{ color: 'var(--color-cream-soft-white)' }}>Anggota</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-terra-light font-serif">{library.stats.visitors.toLocaleString('id-ID')}+</div>
              <div className="text-sm uppercase tracking-wider mt-1" style={{ color: 'var(--color-cream-soft-white)' }}>Pengunjung/Bulan</div>
            </div>
          </div>
          ...
          <div className="animate-[fadeIn_1.8s_ease-in]">
            <a
              ...
              className="inline-flex items-center gap-3 px-10 py-5 font-serif font-bold text-lg transition-all duration-200 shadow-2xl hover:scale-105 active:scale-95"
              style={{ backgroundColor: 'var(--color-secondary)', color: 'var(--color-text-inverse)', border: '2px solid var(--color-secondary)' }}
            >
          ...
          <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce" aria-hidden="true">
            <svg className="w-6 h-6 text-[#C4BDB2]/50" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section 
        id="teras"
        className="py-24 lg:py-32 bg-gradient-to-b from-[#E8E3DB]/30 to-white relative"
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
            ...
            <ScrollFadeIn direction="left" delay={100}>
              ...
              <div className="space-y-3 text-[#C4BDB2]">
                <p className="leading-relaxed">
                  <span className="font-bold text-[#E8E3DB]">Lembaga induk</span> yang menaungi berbagai unit layanan untuk kemajuan pengetahuan dan literasi publik.
                </p>
            ...
            <ScrollFadeIn direction="right" delay={200}>
              ...
              <div className="space-y-3 text-[#C4BDB2]">
                <p className="leading-relaxed">
                  <span className="font-bold text-[#E8E3DB]">Perpustakaan komunitas</span> yang menyediakan akses ke berbagai koleksi buku dan pengetahuan untuk semua kalangan.
                </p>
                <div className="pt-4 border-t border-[#D4A574]/30">
          ...
          <div className="mb-20">
            <ScrollFadeIn direction="up">
              <h3 className="font-serif text-3xl font-bold mb-8 text-center" style={{ color: 'var(--color-text-primary)' }}>
                Unit Layanan Kami
              </h3>
            </ScrollFadeIn>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {units.map((unit, index) => (
                <ScrollFadeIn key={unit.id} direction="up" delay={index * 100}>
                  <div 
                    className="bg-white p-8 transition-all duration-300 group hover:shadow-2xl hover:-translate-y-1 h-full"
                    style={{ borderWidth: '2px', borderStyle: 'solid', borderColor: 'var(--color-border-light)' }}
                >
                  <div className="mb-4 group-hover:scale-110 transition-transform duration-300">
                    <NavIcon icon={unit.icon} className="w-12 h-12" style={{ color: 'var(--color-primary)' }} />
                  </div>
                    <h4 className="font-serif text-lg font-bold mb-2" style={{ color: 'var(--color-text-primary)' }}>
                    {unit.name}
                  </h4>
          ...
          <div className="mt-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <ScrollFadeIn direction="up" delay={0}>
                <Link href="/tentang" className="group block bg-white p-10 transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 h-full" style={{ borderWidth: '1px', borderStyle: 'solid', borderColor: 'var(--color-border-light)' }}>
                  <div className="mb-4 group-hover:scale-110 transition-transform duration-300">
                    <NavIcon icon="users" className="w-12 h-12" style={{ color: 'var(--color-primary)' }} />
                  </div>
                    <h4 className="font-serif text-xl font-bold mb-2" style={{ color: 'var(--color-text-primary)' }}>
                    Ruang Tamu
                  </h4>
                  <p className="text-sm leading-relaxed mb-4" style={{ color: 'var(--color-text-secondary)' }}>
                    Kenali sejarah, visi-misi, dan tim kami
                  </p>
                  <div className="flex items-center gap-2 text-sm font-serif font-bold group-hover:gap-4 transition-all" style={{ color: 'var(--color-secondary)' }}>
                    <span>Masuk</span>
              ...
              <ScrollFadeIn direction="up" delay={100}>
                <Link href="/koleksi" className="group block bg-white p-10 transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 h-full" style={{ borderWidth: '1px', borderStyle: 'solid', borderColor: 'var(--color-border-light)' }}>
                  <div className="mb-4 group-hover:scale-110 transition-transform duration-300">
                    <NavIcon icon="library" className="w-12 h-12" style={{ color: 'var(--color-primary)' }} />
                  </div>
                    <h4 className="font-serif text-xl font-bold mb-2" style={{ color: 'var(--color-text-primary)' }}>
                    Galeri Koleksi
                  </h4>
              ...
              <ScrollFadeIn direction="up" delay={200}>
                <Link href="/baca" className="group block bg-white p-10 transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 h-full" style={{ borderWidth: '1px', borderStyle: 'solid', borderColor: 'var(--color-border-light)' }}>
                  <div className="mb-4 group-hover:scale-110 transition-transform duration-300">
                    <NavIcon icon="read" className="w-12 h-12" style={{ color: 'var(--color-primary)' }} />
                  </div>
                    <h4 className="font-serif text-xl font-bold mb-2" style={{ color: 'var(--color-text-primary)' }}>
                    Ruang Baca
                  </h4>
              ...
              <ScrollFadeIn direction="up" delay={300}>
                <Link href="/artikel" className="group block bg-white p-10 border border-[#D4A574]/20 hover:border-[#2C5F5D] transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 h-full">
                  <div className="mb-4 group-hover:scale-110 transition-transform duration-300">
              ...
              <ScrollFadeIn direction="up" delay={400}>
                <Link href="/belajar" className="group block bg-white p-10 border border-[#D4A574]/20 hover:border-[#2C5F5D] transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 h-full">
                  <div className="mb-4 group-hover:scale-110 transition-transform duration-300">
              ...
              <ScrollFadeIn direction="up" delay={500}>
                <Link href="/penelitian" className="group block bg-white p-10 border border-[#D4A574]/20 hover:border-[#2C5F5D] transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 h-full">
                  <div className="mb-4 group-hover:scale-110 transition-transform duration-300">
              ...
              <ScrollFadeIn direction="up" delay={600}>
                <Link href="/penerbitan" className="group block bg-white p-10 border border-[#D4A574]/20 hover:border-[#2C5F5D] transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 h-full">
                  <div className="mb-4 group-hover:scale-110 transition-transform duration-300">
              ...
              <ScrollFadeIn direction="up" delay={700}>
                <Link href="/kegiatan" className="group block bg-white p-10 border border-[#D4A574]/20 hover:border-[#2C5F5D] transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 h-full">
                  <div className="mb-4 group-hover:scale-110 transition-transform duration-300">
      ...
      {/* ==========================================
          ...
          ========================================== */}
      <section className="py-20 lg:py-24 relative overflow-hidden" style={{ backgroundImage: 'linear-gradient(to right, var(--color-primary), var(--color-primary-dark))' }}>
        {/* Decorative elements */}
        <div className="absolute top-0 right-0 w-96 h-96 rounded-full blur-3xl" aria-hidden="true" style={{ backgroundColor: 'var(--color-secondary)', opacity: 0.1 }}></div>
        <div className="absolute bottom-0 left-0 w-96 h-96 rounded-full blur-3xl" aria-hidden="true" style={{ backgroundColor: 'var(--color-cream-soft-white)', opacity: 0.05 }}></div>
        
        <div className="relative z-10 max-w-4xl mx-auto px-6 lg:px-8 text-center">
          <div className="mb-6">
            <svg className="w-24 h-24 mx-auto" style={{ color: 'var(--color-cream-soft-white)' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <p className="text-xl mb-10 leading-relaxed max-w-2xl mx-auto" style={{ color: 'var(--terra-400)' }}>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/koleksi"
              className="inline-block px-10 py-4 font-serif font-bold text-lg transition-all duration-300 shadow-lg hover:shadow-xl"
              style={{ backgroundColor: 'var(--color-secondary)', color: 'var(--color-text-inverse)', border: '2px solid var(--color-secondary)' }}
            >
              Lihat Koleksi
            </Link>
            <Link
              href="/kontak"
              className="inline-block bg-transparent px-10 py-4 font-serif font-bold text-lg hover:bg-white/10 transition-all duration-300"
              style={{ color: 'var(--color-text-inverse)', border: '2px solid var(--color-border)' }}
            >
              Hubungi Kami
            </Link>
          </div>
      ...
      {/* ==========================================
          Location Preview
          ========================================== */}
      <section className="py-24 lg:py-28 bg-gradient-to-b from-white to-[#E8E3DB]/30">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-[#E8E3DB]/50 border border-[#D4A574]/20 h-96 flex items-center justify-center shadow-inner">
